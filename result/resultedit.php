...
{ 
    if($_SESSION['role_id'] == 2)
    {
        if (isset($_POST['submit']))  
        {
            ...
            $success_url = 'http://' . $_SERVER['HTTP_HOST'] . dirname($_SERVER['PHP_SELF']) . '/resulteditedsuccess.php?' . 'stud_id=' . $stud_id . '&roll_no=' . $roll_no . '&sem=' . $semester . '&year_of_admn=' . $year_of_admn;
